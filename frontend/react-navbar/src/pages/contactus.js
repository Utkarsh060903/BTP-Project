                    ...
                    <div className='contact-body'>
                        ...
                        <div className='row mt-5'>
                            ...
                            <div className='col-lg-3'>
                                <div className='block2 info shadow p-1 mb-1'>
                                    <div className='email'>
                            ...
                            <div className='col-lg-3'>
                                <div className='block3 info shadow p-1 mb-1'>
                                    <div className='phone'>
